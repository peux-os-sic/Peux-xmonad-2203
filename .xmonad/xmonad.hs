...
xmKeys conf@(XConfig {XMonad.modMask = modm}) = M.fromList $
    ...
    -- launch rofi
    , ((modm,               xK_d     ), spawn "exec jgmenu_run")


    -- Audio keys
    , ((0,                    xF86XK_AudioPlay), spawn "exec volume pause")
    , ((0,                    xF86XK_AudioPrev), spawn "exec volume previous")
    , ((0,                    xF86XK_AudioNext), spawn "exec volume next")
    , ((0,                    xF86XK_AudioRaiseVolume), spawn "exec volume up")
    , ((0,                    xF86XK_AudioLowerVolume), spawn "exec volume down")
    , ((0,                    xF86XK_AudioMute), spawn "exec volume mute")

    -- Brightness keys
    , ((0,                    xF86XK_MonBrightnessUp), spawn "exec brightness up")
    , ((0,                    xF86XK_MonBrightnessDown), spawn "exec brightness down ")
    ...
    , ((modm .|.   controlMask, xK_h     ), spawn "pcmanfm-qt")
...
xmStartupHook = do
  ...
  spawnOnce "exec lxqt-powermanagement"
...
defaults = def {
      ...
      -- hooks, layouts
        ...
        layoutHook = gaps [(L,8), (R,8), (U,56), (D,8)] $ spacingRaw True (Border 8 8 8 8) True (Border 8 8 8 8) True $ smartBorders $ xmLayout,
